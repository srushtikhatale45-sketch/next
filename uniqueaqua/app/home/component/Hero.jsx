...
const Hero = () => {
  ...
  const slides = [
    ...
    },
    {
      ...
      subtitle: 'Refresh your style with our new arrivals',
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-black">
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 
        ...
        <span className="text-sm uppercase tracking-wider opacity-70">Scroll</span>
        <div className="w-5 h-10 border-2 border-white/50 rounded-full 
          flex justify-center">
