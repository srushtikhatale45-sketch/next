...
export const metadata = buildMetadata("newsEvents");
export const dynamic = "force-static";
// This page is SSG by default in Next.js 13+ App Router
export default function newsEventsPage() {
   const breadcrumb = getBreadcrumbSchema([
    { name: "Home", href: "/" },
    { name: "News And Events", href: "/newsEvents" },
  ]);
   
  return (
    <SeoWrapper pageUrl="/newsEvents" schemas={[breadcrumb]}>
      ...
      <div className="max-w-2xl mx-auto">
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-sky-600 to-blue-500 px-8 py-10 text-center">
            <h1 className="text-3xl font-bold text-white mb-2">newsEvents</h1>
